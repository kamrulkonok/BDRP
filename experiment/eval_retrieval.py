...
original_weights = model.features[0].weight.clone()  # Save the original weights for reuse
...
def visualize_single_query(query_idx, query_path, dataset_path, rankings, k=3, save_path="query_matches.png"):
    ...
    plt.tight_layout()
    plt.savefig(save_path)  # Save the visualization to a file
    plt.close(fig)  # Close the figure to free memory
    print(f"Visualization saved to {save_path}")


query_idx = 10  # Replace with the index of the query you want to visualize
save_path = "/gpfs/workdir/islamm/output/query_10_matches.png"  # Specify the output file name
