...
class E2ResNet(torch.nn.Module):
    def __init__(
        ...
        self.gspace = gspace
        # Adjusted for grayscale: use 1 channel instead of 3.
        self.in_type = FieldType(gspace, 1 * [gspace.trivial_repr])
        ...
        print("self.in_type.gspace:", self.in_type.gspace)
        print("Expected type:", type(self.gspace)) 
